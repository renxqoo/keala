...
- Runtimes: bun 1.4.0 (raw / eleu / hono) vs node 22 (koa / fastify) vs go 1.27
...
- eleu vs koa 3: **3.81x** (±7% / ±2%)
- eleu vs fastify 5: **3.16x** (±7% / ±2%)
- eleu vs hono 4: **1.01x** (±7% / ±4%)
- eleu vs raw Bun: **1.00x** (±7% / ±5%)
- eleu vs go net/http: **1.27x** (±7% / ±3%)
...
- eleu vs koa 3: **3.95x** (±8% / ±2%)
- eleu vs fastify 5: **3.18x** (±8% / ±3%)
- eleu vs hono 4: **0.99x** (±8% / ±8%)
- eleu vs raw Bun: **0.97x** (±8% / ±9%)
- eleu vs go net/http: **1.25x** (±8% / ±3%)
...
- eleu vs koa 3: **3.89x** (±6% / ±1%)
- eleu vs fastify 5: **3.18x** (±6% / ±1%)
- eleu vs hono 4: **1.00x** (±6% / ±6%)
- eleu vs raw Bun: **0.98x** (±6% / ±5%)
- eleu vs go net/http: **1.24x** (±6% / ±3%)
...
- eleu vs koa 3: **3.53x** (±3% / ±0%)
- eleu vs fastify 5: **2.72x** (±3% / ±14%)
- eleu vs hono 4: **1.07x** (±3% / ±3%)
- eleu vs raw Bun: **0.86x** (±3% / ±1%)
- eleu vs go net/http: **1.11x** (±3% / ±1%)
...
- eleu vs koa 3: **15.83x** (±3% / ±2%)
- eleu vs fastify 5: **2.98x** (±3% / ±1%)
- eleu vs hono 4: **0.99x** (±3% / ±3%)
- eleu vs raw Bun: **1.38x** (±3% / ±2%)
- eleu vs go net/http: **1.31x** (±3% / ±2%)
...
| eleu                  | Text response           |      0.0 |      2.0 |
| eleu                  | JSON response           |      0.0 |      2.0 |
| eleu                  | Param route             |      0.0 |      2.0 |
| eleu                  | 3 middlewares           |      0.0 |      2.0 |
...
| eleu (scale)          | 1000-route scale (late) |      0.0 |      1.0 |
...
| eleu                  |   25.2MB |     51.3MB |   59.1MB |     0.6MB |       0.8MB |
...
| eleu (scale)          |   31.9MB |     51.5MB |   51.5MB |     1.4MB |       1.4MB |
