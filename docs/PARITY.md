...
| compress default         | —                                                              | Web-standard `CompressionStream` (Bun 1.4: 2.7–3.6x faster than the node:zlib async bridge end-to-end, ~2MB less idle; Node: +11µs/op on an optional component)                 |
