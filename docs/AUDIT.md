...
- **性能门禁**：进程内 A/B（以 hono 为对照消除机器漂移）keala/hono 比值 HEAD 1.014-1.022 → 修复后 1.000-1.004，无回归；1422 Node 门 + 1403 Bun 门全绿；四门（fmt/lint/tsc/vitest）全绿。
